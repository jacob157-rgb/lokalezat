<header>
    <nav class="container flex items-center p-4 mx-auto justify-beetwen">
        <!-- Mobile Navigation -->
        ...
        <!-- Logo -->
        <div class="flex-auto ml-5 mr-5 lg:ml-10 lg:mr-0">
            <a href="/" class="items-center flex-auto">
                <img class="block float-right h-8 md:hidden lg:hidden lg:float-none"
                    src="{{ asset('assets/logo/icon.png') }}" alt="">
                <img class="hidden float-right h-8 md:block lg:block lg:float-none"
                    src="{{ asset('assets/logo/logo_blk.png') }}" alt="">
            </a>
        </div>
        ...
        <div class="flex-auto hidden lg:block">
            <form>
                <div class="relative flex">
                    ...
                    <button type="submit"
                        class="text-white absolute end-2.5 bottom-2.5 bg-primary hover:bg-primary focus:bg-red-800 rounded-lg text-sm px-4 py-2">Cari
